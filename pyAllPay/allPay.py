...
from pyallpay.setting import HASH_IV, HASH_KEY, AIO_SANDBOX_SERVICE_URL, AIO_SERVICE_URL, RETURN_URL, MERCHANT_ID
import time
import datetime
import urllib
import hashlib
...
class AllPay():
    ...
    def __init__(self, payment_conf, service_method='post'):
        ...
        self.url_dict['ChoosePayment'] = 'CVS' if not ('ChoosePayment' in payment_conf) else payment_conf['ChoosePayment']
        ...
        self.url_dict['OrderResultURL'] = '' if not ('OrderResultURL' in payment_conf) else payment_conf['OrderResultURL']
        self.url_dict['ClientBackURL'] = '' if not ('ClientBackURL' in payment_conf) else payment_conf['ClientBackURL']
        # self.url_dict['PaymentInfoURL'] = '' if not ('PaymentInfoURL' in payment_conf) else payment_conf['PaymentInfoURL']
